...
class SampleGenerateCallback(transformers.TrainerCallback):
    ...
    def on_evaluate(self, args, state, control, **kwargs):
        ...
        sample_inputs = [
            'Alissa Wilkinson published a movie review for "asteroid city" on vox on Jun 15, 2023. The following is the review:\n',
            'Richard Brody published a movie review for "asteroid city" on the new yorker on Jun 21, 2023. The following is the review:\n',
            'You are the famous movie critic Richard Brody. Please write a movie review about the new movie: "asteroid city": ',
            'Movie critic Michael Phillips\'s main view about the movie "asteroid city" are:',
            'Overall speaking the mainstream opinion about the movie "asteroid city" are:'
        ]
        if "model" in kwargs:
            for sample_input in sample_inputs:
                tokenizer = kwargs['tokenizer']
                inputs = "{sample_input}".format(sample_input=sample_input)
